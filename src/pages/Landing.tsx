...
const features = [
  {
    icon: CheckSquare,
    title: "Smart Checklista",
    description: "16+ uppgifter sorterade efter tidslinje. Håll koll på alla detaljer från bokningar till sista justeringar.",
  },
  {
    icon: Wallet,
    title: "Budgetverktyg",
  ...
  },
  {
    ...
    description: "Visuell tidslinje med alla milstolpar. Missa aldrig en viktig deadline.",
  },
  {
    icon: TrendingUp,
    title: "Framstegsspårning",
    description: "Se ert framsteg med tydliga visualiseringar. Känn lugnet i att veta var ni står.",
  },
];
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            <h2 className="font-serif text-4xl font-medium text-foreground mb-4">
              Allt ni behöver för planeringen
            </h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Från första idén till er stora dag. Vi har samlat alla verktyg ni behöver.
            </p>
          </motion.div>
      ...
      <section className="py-20 px-4 sm:px-6">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Kom igång på under en minut och börja planera direkt.
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                description: "Gå igenom uppgifterna i rätt ordning och bocka av.",
                icon: CheckSquare,
              },
              {
                step: "03",
                title: "Håll koll på budgeten",
                description: "Lägg in kostnader och se att ni håller er budget.",
                icon: Wallet,
              },
            ].map((item, i) => (
              <motion.div
              ...
              >
                <div className="relative inline-block mb-6">
                  <div className="w-20 h-20 rounded-2xl bg-sage-gradient flex items-center justify-center shadow-lg">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <p className="text-sm text-muted-foreground">
              © 2024 Wedding Planner Pro. Med kärlek för er stora dag.
            </p>
          </div>
        </div>
      </footer>
